          ...
          <div className='flex flex-col md:flex-row'>
            ...
            <div className='hidden md:flex flex-col space-y-4 mr-6'>
              {
                selectedProduct.images.map((image, index) => (
                  <img
                    ...
                    className={`w-20 h-20 rounded-lg  object-cover cursor-pointer border ${mainImage === image.url ? "border-black" : "border-gray-300"
                      }`}
            ...
            <div className='md:w-1/2 md:ml-10'>
              ...
              <button
                ...
                className={`w-full bg-black text-white px-6 py-2 rounded mb-4 ${isButtonDisabled ? "cursor-not-allowed opacity-50" : "hover:bg-gray-900"
                  }`}>
